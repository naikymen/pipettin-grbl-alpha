...
// Pipettin GRBL servo models //
rack(modul=1, length=89, height=6, width=6, pressure_angle=20, helix_angle=0);

//translate([0,10,0])
//spur_gear (modul=1, tooth_number=15, width=7, bore=6, pressure_angle=20, helix_angle=0, optimized=false);

//rack_and_pinion (modul=1, rack_length=41.2, gear_teeth=12, rack_height=5, gear_bore=5, width=5, pressure_angle=20, helix_angle=0, together_built=true, optimized=false);
...
//herringbone_gear (modul=1, tooth_number=100, width=12, bore=34.8, pressure_angle=20, helix_angle=30, optimized=true);
...
//bevel_herringbone_gear_pair(modul=1.5, gear_teeth=32, pinion_teeth=10, axis_angle=90, tooth_width=5, gear_bore=35, pinion_bore=6, pressure_angle = 20, helix_angle=20, together_built=true);
